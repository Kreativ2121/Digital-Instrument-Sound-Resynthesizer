...
%   save computing power.
    fletcherAndMundson40dBEqualLoudnessCurveX = double(.05 + ...
        double(4000./frequency));
    fletcherAndMundson40dBEqualLoudnessCurve = ...
        fletcherAndMundson40dBEqualLoudnessCurveX .* ...
        10.^(-fletcherAndMundson40dBEqualLoudnessCurveX);
end
