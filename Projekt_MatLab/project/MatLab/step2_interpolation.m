function [peaks] = step2_interpolation(frequencyPeaksdBFiltered, magnitudeDecibels, frequency, fletcher_and_munson_40dB)
    ...
    for i=1:size(frequencyPeaksdBFiltered,2)
        ...
        if(frequencyPeaksdBFiltered(2,i)-1 == 0)
            peaks(7,i) = (magnitudeDecibels(frequencyPeaksdBFiltered(2,i), ...
                ...
                +fletcher_and_munson_40dB(frequencyPeaksdBFiltered(2,i))*magnitudeDecibels(frequencyPeaksdBFiltered(2,i), ...
                frequencyPeaksdBFiltered(3,i)));
        else
            ...
            peaks(7,i) = (magnitudeDecibels(frequencyPeaksdBFiltered(2,i)-1, ...
                frequencyPeaksdBFiltered(3,i)) ...
                +fletcher_and_munson_40dB(frequencyPeaksdBFiltered(2,i))*magnitudeDecibels(frequencyPeaksdBFiltered(2,i)-1, ...
                frequencyPeaksdBFiltered(3,i)));
        end
